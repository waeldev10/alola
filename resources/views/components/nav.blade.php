...
<nav class="container mx-auto px-6 md:px-20 py-5 shadow-md">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center space-x-5 space-x-reverse">
            ...
            <div class="relative">
                ...
                <input type="text" placeholder="ابحث عن خدمة..." class="w-64 bg-gray-100 text-sm rounded-lg py-3 pr-4 pl-10 focus:outline-none focus:ring-2 focus:ring-cyan-400">
            </div>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-12 space-x-reverse">
            <div class="hidden md:flex items-center space-x-6 space-x-reverse text-sm text-gray-700">
                <a href="#" class="font-bold text-[#2F537D]">الرئيسية</a>
                <a href="#" class="hover:text-cyan-600 transition-colors">عن المنصة</a>
                <a href="#" class="hover:text-cyan-600 transition-colors">المناطق</a>
                <a href="#" class="hover:text-cyan-600 transition-colors">الكوبونات والعروض</a>
                <a href="#" class="hover:text-cyan-600 transition-colors">الخريطة</a>
                <a href="#" class="hover:text-cyan-600 transition-colors">الأطباء</a>
                <a href="#" class="hover:text-cyan-600 transition-colors">البطاقات والاشتراك</a>
                
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" class="flex items-center hover:text-cyan-600 transition-colors">
                        <span>الدول</span>
